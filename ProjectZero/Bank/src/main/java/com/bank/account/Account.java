...
public class Account  {
	...
	public String toString() {
		...
		return String.format( "   %6d         %13s           %10.2f      %s       %s",accountID, accNumber, balance, type, pending);
	}
	...
	public void setAccState(String x) {
		this.state = x;
	}
	...
	public String deposit(double amount, CustomerConnect cDAO) {
	...
	public String withdraw(double amount, CustomerConnect cDAO) {
	...
	private void balanceUpdate(CustomerConnect cDAO) {
	...
	public boolean startTransfer(CustomerConnect cDAO, String accNumber, double amount) {
	...
	public ArrayList<Transfers> getTransfers(CustomerConnect cDAO) {
	...
	public ArrayList<Transfers> getPendingTransfer(CustomerConnect cDAO){
