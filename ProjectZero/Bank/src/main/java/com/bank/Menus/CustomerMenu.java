...
public class CustomerMenu implements MenuInterface{
	...
	private int displayAccountWithNumberOptions() {
		...
		System.out.println();
		System.out.println("   Option      Account Number     Account Balance    Account type");
		System.out.println("--------------------------------------------------------------------------------");
	...
	private int viewAccounts() {
		...
		System.out.println();
		System.out.println("   User ID        Account Number     Account Balance     Account Type     Status");
		System.out.println("--------------------------------------------------------------------------------");
		for(int i = 0; i<accList.size(); i++) 
