...
public class EmployeeMenu implements MenuInterface{
	...
	private void viewAllAccounts() {
		...
		if(accList.size()!=0) {
			System.out.println("        ID        Account Number     Account Balance      Account type   Status");
			System.out.println("--------------------------------------------------------------------------------------");
	...
	private void viewCustomerAccounts() {
		System.out.println();
		System.out.println("Type in Customer's username");
	...
	private void decideAccount() {
		...
		while(going) {
			...
			System.out.println();
			System.out.println("   Option      ID         Account Number     Account Balance      Account type   Status");
			System.out.println("--------------------------------------------------------------------------------------");
		try {
		for(int i = 0; i<accList.size(); i++ )
